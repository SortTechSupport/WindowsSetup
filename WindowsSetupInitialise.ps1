...
Invoke-WebRequest -Uri https://raw.githubusercontent.com/SortTechSupport/WindowsSetup/refs/heads/main/OfficeSetup/UninstallOffice.xml -Outfile ".\UninstallOffice.xml"
