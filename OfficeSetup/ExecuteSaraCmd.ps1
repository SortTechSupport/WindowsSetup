...
#
$resultsFileName = $env:COMPUTERNAME + "_<scenario>_$currentTimeStamp.zip"
#
#****************************************************************************************************
#
# ==================
...
$LocalLogFolder = "$currentLocation\Logs"
...
If($OfficeInstalled){
  Write-Verbose "$($OfficeVersionInstalled) uninstalled failed!"
}Else{
